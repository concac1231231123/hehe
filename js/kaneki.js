...
function handleClick(app) {
  switch (app) {
    case "chrome":
      window.location.href = "bsapps://chrome";
      break;
    case "camera":
      window.location.href = "bsapps://camera";
      break;
    case "media":
      window.location.href = "bsapps://media";
      break;
    case "android":
      window.location.href = "bsapps://settings";
      break;
    case "playStore":
      window.location.href = "bsapps://playstore";
      break;
    default:
      alert("App '" + app + "' chưa được định nghĩa.");
  }
}
